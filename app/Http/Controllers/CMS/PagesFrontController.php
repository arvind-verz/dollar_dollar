                                ...
                                <h4 class="slider-heading">
                                    <strong>
                                        ...
                                        if ($product->by_order_value == TENURE) {
                                            if ($product->promotion_period==ONGOING) { echo '<span class="highlight-slider"> '.$product->promotion_period.'</span>' ; } else { 
                                ...
                                Rate: </span><?php echo $product->maximum_interest_rate; ?>%</p>
                                    ...
                                    <?php } else { ?>
                                        <p class="<?php if ($product->by_order_value == TENURE) echo 'highlight highlight-bg'; ?>">
                                            <?php if ($product->promotion_period==ONGOING) { echo $product->promotion_period ; } else { ?> 

        ...
        <div class="product-col-01 home-featured">
            ...
            <div class="ps-slider--feature-product saving">
                ...
                <div class="ps-block--short-product second highlight"
                   ...
                   <div class="slider-img"><img data-sizes="auto"  style="height:60px" class="lazyautosizes lazyload" alt="" data-src="{{ asset($product->brand_logo) }}"></div>
        ...
        @foreach ($products as $product)
            ...
            @if ( $product->featured==0)
                ...
                <div class="ps-block--short-product second">
                    ...
                    <div class="slider-img"><img data-sizes="auto" class="lazyautosizes lazyload" style="height:60px" alt="" data-src="{{ asset($product->brand_logo) }}"></div>

                                                    ...
                                                    <div class="col-sm-6 col-md-3">
                                                        <div class="row-inner">
                                                            ...
                                                            <div class="product-box">
                                                                @if(isset($q))
                                                                    <a href="{{ route("get-promotion-product-detail",["id"=>$product->id,"product_category"=>$productCategory,"search"=>$q]) }}">
                                                                        @else
                                                                            <a href="{{ route("get-promotion-product-detail",["id"=>$product->id,"product_category"=>$productCategory]) }}">
                                                                                @endif
                                                                                @if($productCategory != SPARE)
                                                                                ...
                                                                                @endif
                                                                                @if($productCategory == SPARE)
                                                                                    <div class="product-name">{{$product->item_no}}</div>
                                                                                @else

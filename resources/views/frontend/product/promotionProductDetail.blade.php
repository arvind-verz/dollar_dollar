        ...
        <div class="container">
            <ul>
                ...
                @if($productCategory == SEARCH)
                    <li><a href="{{route("search",["search"=>$search]) }}">{{SEARCH}}</a></li>
                @elseif($productCategory == SPARE)
                    @if($parent_category)
                        <li>
                            <a href="{{ route("get-products-category",["division"=>$parent_category->division]) }}"> {{$parent_category->category}}</a>
                        </li>
                    @endif
                    <li>
                        <a href="{{ route("get-products-category",["division"=>$product->division]) }}"> {{$product->category}}</a>
                    </li>
                @elseif($productCategory == PROMOTION)
                    <li>
    ...
    <div class="fullcontainer">
        <div class="container">
            <div class="inner-container md">
                    ...
                    <div class="col-lg-7">
                        <div class="row-inner">
                            <div class="product-info-main">
                                ...
                                @if(($products->count()>1) && ( !in_array($productCategory,[SPARE,PROMOTION])))
                                    <div class="product-code pb10">
                                        <select class="selectpicker" name="product_id"
                                            ...
                                            @foreach($products as $p)
                                                <option value="{{$p->id}}">{{$p->item_no}}&emsp;{{$p->description}}
                                                </option>
                                            @endforeach
                                        </select>
                ...
                @endif
                @if(count($related_products) ||$recentProducts)
                    <hr>
                @endif
                ...
                @if(count($recentProducts))
                    ...
                    <div class="slider product-slider">
                        <div id="recent-product-slider" class="owl-carousel"
                             data-count="{{count($recentProducts)}}">
                            @foreach($recentProducts as $recent_product)
                                <div class="item">
                                    <div class="product-box"><a

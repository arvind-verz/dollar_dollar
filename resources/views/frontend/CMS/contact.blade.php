...
<main class="ps-main">
    <div class="container">
		...
		<div class="text-center">
			...
			<p><i class="fa fa-phone-square fa-2x" aria-hidden="true"></i></p>
			<p><a href="tel:+6591552665">Tel: (65) 9155 2665</a></p>
			<p><i class="fa fa-envelope fa-2x" aria-hidden="true"></i></p>
			<p><a href="mailto:enquiry@dollardollar.sg">enquiry@dollardollar.sg</a></p>
		</div>

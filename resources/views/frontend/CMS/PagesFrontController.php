        ...
        if ($promotion_products->count()) {
            foreach ($promotion_products as $key => $product) {
                ...
                if ($product->promotion_formula_id == LOAN_F1) {
                    ...
                    if ($completion != $firstProductRange->completion_status) {
                        $status = false;
                    }
                    ...
                    <form id="form-<?php echo $product->product_id; ?>" class="ps-form--filter" method="post">
                        <table class="ps-table ps-table--product ps-table--product-3">
                            ...
                            <tr>
                                ...
                                <th class="combine-criteria-padding <?php if($product->salary_highlight==true || $product->salary_highlight_2==true ) { echo'active'; } ?>" style="width:9%">SALARY</th>
                                <th class="combine-criteria-padding <?php if($product->payment_highlight==true  ) { echo'active'; } ?>" style="width:9%">Giro</th>
                                <th class="combine-criteria-padding <?php if($product->spend_highlight==true || $product->spend_highlight_2==true ) { echo'active'; } ?>" style="width:9%">SPEND</th>
                                    ...
                                    <div class="row">
                                        <div class="width-50">
                                            <div class="ps-checkbox">
                                                ...
                                                <label
                                                    for="housing-loan-<?php echo $product->product_id; ?>" class="<?php if($product->housing_loan_highlight==true  ) { echo'active'; } ?>">Housing</label>
                                            </div>
                                            <div class="ps-checkbox">
                                                <input class="form-control" type="checkbox"
                                                       data-status="<?php echo $highlightStatus; ?>"
                                                ...
                                                <label
                                                    for="education-loan-<?php echo $product->product_id; ?>" class="<?php if($product->education_loan_highlight==true  ) { echo'active'; } ?>">Education</label>
                                            </div>
                                        </div>
                                        <div class="width-50">
                                            <div class="ps-checkbox">
                                                ...
                                                <label for="hire-loan-<?php echo $product->product_id; ?>" class="<?php if($product->hire_loan_highlight==true  ) { echo'active'; } ?>">Hire
                                                    loan</label>
                                            </div>
                                            <div class="ps-checkbox">
                                                <input class="form-control" type="checkbox"
                                                ...
                                                <label
                                                    for="renovation-loan-<?php echo $product->product_id; ?>" class="<?php if($product->renovation_loan_highlight==true  ) { echo'active'; } ?>">Renovation</label>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="width-50">
                                            <div class="ps-checkbox">
                                                ...
                                                <label
                                                    for="life-insurance-<?php echo $product->product_id; ?>" class="<?php if($product->life_insurance_highlight==true  ) { echo'active'; } ?>">Insurance</label>
                                            </div>
                                            <div class="ps-checkbox">
                                                <input class="form-control" type="checkbox"
                                                       onchange="changeCriteria(this);"
                                                ...
                                                <label for="unit-trust-<?php echo $product->product_id; ?>" class="<?php if($product->unit_trust_highlight==true  ) { echo'active'; } ?>">Unit</label>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <table class="ps-table ps-table--product ps-table--product-3">
                            ...
                            <tr>
                                ...
                                if (!empty($firstRange->minimum_salary)) { ?>
                                    <th class="<?php if($product->salary_highlight==true || $product->salary_highlight_2==true) { echo'active'; } ?>">SALARY</th> <?php }
                                if (!empty($firstRange->minimum_giro_payment)) { ?>

                                    <th class="<?php if($product->payment_highlight==true ) { echo'active'; } ?>">PAYMENT</th> <?php }
                                if (!empty($firstRange->minimum_privilege_pa)) { ?>

                                    <th class="<?php if($product->privilege_highlight==true ) { echo'active'; } ?>">PRIVILEGE</th> <?php }
                                if (!empty($firstRange->minimum_loan_pa)) { ?>
                                    <th class="<?php if($product->loan_highlight==true ) { echo'active'; } ?>">LOAN</th> <?php }
                                        ...
                                        <div class="">
                                            <div class="width-50">
                                                <div class="ps-checkbox">
                                                    ...
                                                    <label
                                                        for="other-interest1-<?php echo $product->product_id; ?>" class="<?php if($product->other_highlight1==true ) { echo'active'; } ?>"><?php echo $firstRange->other_interest1_name; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </th>
                                        ...
                                        <div class="">
                                            <div class="width-50">
                                                <div class="ps-checkbox">
                                                    ...
                                                    <label
                                                        for="other-interest2-<?php echo $product->product_id; ?>" class="<?php if($product->other_highlight2==true ) { echo'active'; } ?>"><?php echo $firstRange->other_interest2_name; ?></label>
                                                </div>
                                            </div>
                                        </div>
                                    </th>

...
@section('content')
    ...
    <div class="ps-page--deposit">
        ...
        <div class="ps-slider--feature-product nav-outside owl-slider" data-owl-auto="true" data-owl-loop="true"
             data-owl-speed="5000" data-owl-gap="0" data-owl-nav="true" data-owl-dots="false" data-owl-item="3"
             data-owl-item-xs="1" data-owl-item-sm="2" data-owl-item-md="3" data-owl-item-lg="3"
                ...
                @if($promotion_product->formula_id==8)
                    <div class="ps-product ps-product--2">
                        ...
                        <div class="ps-product__content">
                            <h4 class="ps-product__heading"><strong class="highlight">UOB One Account:</strong> Meet
                                either of Criteria and earn up to 3.33%</h4>
                                    ...
                                    @foreach($product_range as $range)
                                        ...
                                        <tr>
                                            ...
                                            <td>@if($i==1) First @else Next @endif ${{ $range->max_range }} -
                                                ${{ round($range->max_range*($spend_giro/100), 2) }} ({{ $spend_giro }}
                                                %)
                                            </td>
                                            @if($i==1)
                                                <td class="" rowspan="4">${{ array_sum($interest_earned_arr) }}
                                                    <br> Effective Interest Rate {{ array_sum($total_interest) }}%
                                                </td>
                                            @endif
                                        </tr>
                                        @php $i++; @endphp
                                ...
                                <div class="ps-criteria-detail">
                                    ...
                                    <div class="ps-criteria-detail__content">
                                        <ul class="ps-list--arrow-circle">
                                            <li>Spend minimum of $500 in total across all UOB Credit card such as lady
                                                cards, one card and YOLO Card
                                            </li>
                                            <li>You has to be primary account holder and principal card member</li>
                                            <li>Eligible transaction with posting date within calendar month will be
                                                considered
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="ps-product ps-product--2">
                            ...
                            <div class="ps-product__content">
                                <h4 class="ps-product__heading"><strong class="highlight">Maybank – Saveup
                                        Account:</strong> Fulfil each criteria and earn up to 3.0%</h4>
                                ...
                                <div class="ps-table-wrap">
                                    <table class="ps-table ps-table--product ps-table--product-3">
                                        ...
                                        @foreach($product_range as $range)
                                            @php
                                            $bonus_interest_salary = $minimum_giro_payment = $bonus_interest_spend =
                                            $bonus_interest_wealth = 0;
                                            $input = 20000;
                                            $total_interest_arr = [];
                                            ...
                                            (($range->first_cap_amount*$total_interest)+($range->bonus_interest_remaining_amount*($range->max_range-$range->first_cap_amount)));
                                            @endphp
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center" colspan="4">First
                                                    ${{ $range->first_cap_amount }} -
                                                    ${{ ($range->first_cap_amount*$total_interest) }} (
                                                    = {{ $range->bonus_interest }}%), next
                                                    ${{ ($range->max_range-$range->first_cap_amount) }} -
                                                    ${{ ($range->bonus_interest_remaining_amount*($range->max_range-$range->first_cap_amount)) }}
                                                    ({{ $range->bonus_interest_remaining_amount }}%) Total =
                                                    ${{ $total_interest_earned }}</td>
                                            </tr>
                                        @endforeach
                                        </tbody>
                                    </table>
                                ...
                                <div class="ps-product__content">
                                    ...
                                    <div class="ps-table-wrap">
                                        <table class="ps-table ps-table--product ps-table--product-3">
                                            ...
                                            <tr>
                                                <td colspan="2">Total Bonus Interest Earned for $100k</td>
                                                <td class="highlight text-center" colspan="8">First $60k - $XXX ( =
                                                    2.0%), next $40k - $xxxx (0.375) Total = $ XXX
                                                </td>
                                            </tr>
                                            </tbody>
                                        </table>

        ...
        <div class="container">
            ...
            @if(count($promotion_products))
                ...
                @foreach($promotion_products as $promotion_product)
                    ...
                    $max_range_arr = array();
                    @endphp
                    @if(count($promotion_products)>2 && $page->slug=='wealth-deposit-mode')
                ...
                @endforeach
            @else
            @if($page->slug=='wealth-deposit-mode')<div class="ps-poster"><a href="{{ isset($adspopup[0]->ad_link_horizontal_popup) ? $adspopup[0]->ad_link_horizontal_popup : '' }}"><img src="{{ isset($adspopup[0]->ad_horizontal_image_popup) ? asset($adspopup[0]->ad_horizontal_image_popup) : '' }}" alt=""></a></div>@endif
            @endif
        </div>
    </div>

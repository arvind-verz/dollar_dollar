        ...
        <div class="container" id="logo-detail">
            ...
            @if($products->count())
                ...
                @foreach($products as $product)
                    ...
                    @endif
                    <div class="ps-product  @if($product->featured==1) featured-1 @endif @if($page->slug==FOREIGN_CURRENCY_DEPOSIT && isset($ads[3]->ad_horizontal_image_popup_top)) product-popup @endif"
                         id="{{ $j }}">
                                        ...
                                        <div class="ps-product__panel">
                                            @if(count($interestEarns))
                                                @foreach($tenures as $tenureKey => $value)
                                                    ...
                                                    @endif
                                                    <p><strong>{{ $value . ' ' . $type }}</strong> - {{$product->currency_code}} ${{ Helper::inThousand($interestEarns[$tenureKey]) }}
                                            ...
                                            @if($product->promotion_formula_id==FOREIGN_CURRENCY_DEPOSIT_F2)
                                                ...
                                                <div class="ps-product__panel">
                                                    ...
                                                    <h2> @if(($product->total_interest_earn)<=0)
                                                            - @else
                                                            {{$product->currency_code}} ${{ Helper::inThousand($product->total_interest_earn) }} @endif
                                                        <br>
                                                <span>
                                                                                                ...
                                                                                                <tr class="@if($product->highlight==true ) highlight @endif">
                                                                                                    ...
                                                                                                    @elseif($key==3)
                                                                                                        ...
                                                                                                        <td>@if($product->total_interest_earn <=0 )
                                                                                                                - @else
                                                                                                                {{$product->currency_code}} ${{$product->total_interest_earn }} @endif
                                                                                                            {{-- <br/>
                                                                                                             <span>
                                                                                                                 Total interest rate {{ $product->total_interest }}%
                                                                                                             </span>--}}
                                            ...
                                            @if(count($interestEarns))
                                                @foreach($tenures as $tenureKey => $value)
                                                    ...
                                                    <p><strong>{{ $value . ' ' . $type }}</strong> -
                                                        {{$product->currency_code}} ${{ Helper::inThousand($interestEarns[$tenureKey]) }}
                                                        ({{ $bonusInterests[$tenureKey] . '%' }})</p>
                                                @endforeach

                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$productRange->bonus_interest+$productRange->rate_interest_other}}%
                                        ...
                                        @elseif(empty($productRange->floating_rate_type)&&!empty($productRange->bonus_interest)&&!empty($productRange->rate_name_other)&& !empty($productRange->rate_interest_other))            ({{$productRange->bonus_interest}}% + {{$productRange->rate_interest_other}}% ({{$productRange->rate_name_other}}))
                                        @elseif(!empty($productRange->floating_rate_type)&&!empty($productRange->bonus_interest)&&!empty($productRange->rate_name_other)&& !empty($productRange->rate_interest_other))            ({{$productRange->floating_rate_type}} + {{$productRange->rate_interest_other}}% ({{$productRange->rate_name_other}}))
                                        ...
                                        @elseif(empty($productRange->floating_rate_type)&&!empty($productRange->bonus_interest)&&empty($productRange->rate_name_other)&& !empty($productRange->rate_interest_other))            ( {{$productRange->bonus_interest}}% + {{$productRange->rate_interest_other}}%)
                                        @elseif(empty($productRange->floating_rate_type)&&empty($productRange->bonus_interest)&&empty($productRange->rate_name_other)&& !empty($productRange->rate_interest_other))
                                        @elseif(!empty($productRange->floating_rate_type)&&!empty($productRange->bonus_interest)&&empty($productRange->rate_name_other)&& !empty($productRange->rate_interest_other))
                                        ({{$productRange->floating_rate_type}} + {{$productRange->rate_interest_other}}% )
                                        @endif
                                    </td>
                                    <td class=" @if($productRange->tenure_highlight==true) highlight @endif ">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @elseif(empty($productRanges[0]->there_after_rate_type)&&!empty($productRanges[0]->there_after_bonus_interest)&&!empty($productRanges[0]->there_after_rate_name_other)&& !empty($productRanges[0]->there_after_rate_interest_other))            ({{$productRanges[0]->there_after_bonus_interest}}% + {{$productRanges[0]->there_after_rate_interest_other}}% ({{$productRanges[0]->there_after_rate_name_other}}))
                                        @elseif(!empty($productRanges[0]->there_after_rate_type)&&!empty($productRanges[0]->there_after_bonus_interest)&&!empty($productRanges[0]->there_after_rate_name_other)&& !empty($productRanges[0]->there_after_rate_interest_other))            ({{$productRanges[0]->there_after_rate_type}} + {{$productRanges[0]->there_after_rate_interest_other}}% ({{$productRanges[0]->there_after_rate_name_other}}))
                                        ...
                                        @elseif(empty($productRanges[0]->there_after_rate_type)&&!empty($productRanges[0]->there_after_bonus_interest)&&empty($productRanges[0]->there_after_rate_name_other)&& !empty($productRanges[0]->there_after_rate_interest_other))            ( {{$productRanges[0]->there_after_bonus_interest}}% + {{$productRanges[0]->there_after_rate_interest_other}}%)
                                        @elseif(empty($productRanges[0]->there_after_rate_type)&&empty($productRanges[0]->there_after_bonus_interest)&&empty($productRanges[0]->there_after_rate_name_other)&& !empty($productRanges[0]->there_after_rate_interest_other))
                                        @elseif(!empty($productRanges[0]->there_after_rate_type)&&!empty($productRanges[0]->there_after_bonus_interest)&&empty($productRanges[0]->there_after_rate_name_other)&& !empty($productRanges[0]->there_after_rate_interest_other))
                                         ({{$productRanges[0]->there_after_rate_type}} + {{$productRanges[0]->there_after_rate_interest_other}}% )
                                        @endif
                                    </td>

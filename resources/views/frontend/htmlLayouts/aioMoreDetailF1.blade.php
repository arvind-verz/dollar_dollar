    ...
    <div class="ps-criteria-detail">
        ...
        <div id="formula-1-salary" class="ps-criteria-detail__content">
            <ul class="ps-list--arrow-circle">
                ...
                <li>Only salary credit through giro with transaction description &lsquo;Giro &ndash;Salary&rsquo; in your statement will qualify.</li>
            </ul>
        </div>

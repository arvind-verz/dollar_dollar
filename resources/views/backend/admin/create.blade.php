...
@section('content')
    <section class="content-header">
        <h1>
            ...
            <small>{{USER_MODULE_SINGLE.' '.ADD_ACTION}}</small>
        </h1>
        <ol class="breadcrumb">
            <li><a href="{{ route('admin.dashboard') }}"><i class="fa fa-home"></i>{{DASHBOARD}}</a></li>
            <li><a href="{{ route('admins.index') }}">{{USER_MODULE_SINGLE}}</a></li>
            <li class="active">{{USER_MODULE_SINGLE.' '.ADD_ACTION}}</li>
        </ol>
    </section>
            ...
            <div class="col-xs-12">
                <div class="box box-info ">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">{{USER_MODULE_SINGLE.' '.ADD_ACTION}}</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <!-- form start -->
                        {!! Form::open(['class' => 'form-horizontal','url' => 'admin/admins', 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {{Form::text('email', old('first_name'), ['class' => 'form-control', 'placeholder' => ''])}}
                                </div>
                            </div>
                            <div class="form-group">

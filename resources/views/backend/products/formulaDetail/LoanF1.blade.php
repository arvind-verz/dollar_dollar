    ...
    @else
        ...
        <div id="saving_placement_range_f4_0">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-8">
                    <select class="form-control" name="rate_type" id="currency">
                        <option value="">None</option>
                        <option value="1">{{FIX_RATE}}</option>
                        <option value="2">{{FLOATING_RATE}}</option>
                    </select>
                </div>
                <div class="col-sm-2">
                </div>
                ...
                <div class="col-sm-8 ">
                    <div class="form-row">
                        <div class="col-md-6 mb-3">
                            ...
                            <select class="form-control" name="rate_type" id="currency">
                                <option value="">None</option>
                                <option value="1">{{FIX_RATE_TYPE}}</option>
                                <option value="2">{{SIBOR_RATE_TYPE}}</option>
                            </select>

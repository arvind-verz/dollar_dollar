        ...
        <div class="col-sm-8 ">
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    ...
                    <input type="text" class="form-control only_numeric" id=""
                    name="minimum_salary_aioa4_2" value="{{ isset($value->minimum_salary_2)?$value->minimum_salary_2:null}}"
                    placeholder="">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="">Minimum Amount (Spend 2)</label>
                    <input type="text" class="form-control only_numeric" id=""
                    name="minimum_spend_aioa4_2"
                    value="{{ isset($value->minimum_spend_2)?$value->minimum_spend_2:null}}"
                    placeholder="">
                </div>
                <div class="col-md-4 mb-3">
        ...
        <div class="col-sm-8 ">
            <div class="form-row">
                <div class="col-md-4 mb-3">
                    <label for="">Minimum Amount (Salary 2)</label>
                    <input type="text" class="form-control only_numeric" id=""
                    name="minimum_salary_aioa4_2" value=""
                    placeholder="">
                </div>
                <div class="col-md-4 mb-3">
                    <label for="">Minimum Amount (Spend 2)</label>

                                        ...
                                        <div class="col-sm-10 ">
                                            <div class="input-group date ">
                                                ...
                                                <input type="text" class="form-control pull-right datepicker1"
                                                       ...
                                                       @if($product->promotion_period==ONGOING) disabled="disabled"
                                                       @endif
                                ...
                                <div class="tab-pane" id="basic-detail">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="text-muted col-sm-offset-2 col-md-12"><strong>Note:</strong> Image
                                            size should be @if($product->promotion_type_id==ALL_IN_ONE_ACCOUNT)
                                                1140*160 @else 1140*160 @endif for better display
                                        </div>
                                    </div>
                                    <div class="form-group">

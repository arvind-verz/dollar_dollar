                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="page_type">
                                    ...
                                    <option value="{{LOAN_MODE}}"
                                            @if($ads->page_type==LOAN_MODE) selected @endif>LOAN
                                    </option>
                            ...
                            @endif
                            <div class="form-group">
                                <input type="hidden" id="paid-ads-status" name="paid_ads_status" value="{{$ads->paid_ads_status}}"/>
                                <label>Paid Ads</label>
                                <div style="width:20%" id="paid-ads">
                                    @if($ads->paid_ads_status==1)
                            ...
                            <div class="form-group">
                                ...
                                Image @endif</label>
                                <input type="file" name="paid_ad_image" class="form-control paid-ad" @if($ads->paid_ads_status==0) disabled="disabled" @endif>
                                <p class="text-muted"><strong>Note:</strong> Image
                                    size should be @if($type=='account'||$type=='blog')277*600 @elseif($type=='email') 570*200 @else 1200*350 @endif for better display
                                </p>
                            ...
                            <div class="form-group">
                                ...
                                Link @endif</label>
                                <input type="text" name="paid_ad_link" class="form-control paid-ad-text" @if($ads->paid_ads_status==0) readonly="readonly"  @endif
                                placeholder="Enter Ad link (example: https://www.google.com)"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="horizontal_paid_ad_link" class="form-control paid-ad-text" @if($ads->paid_ads_status==0) readonly="readonly" @endif
                                placeholder="Enter Ad link (example: https://www.google.com)"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ad_range_date" class="form-control date_range paid-ad" @if($ads->paid_ads_status==0) disabled="disabled" @endif

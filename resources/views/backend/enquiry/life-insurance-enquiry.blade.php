            ...
            <div class="col-xs-12">
                <div class="box box-info ">
                    <div class="box-header with-border">
                        ...
                        <h3 class="box-title">{{LIFE_INSURANCE_ENQUIRY_MODULE}}</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                            ...
                            <tr>
                                <td>
                                    <div style="width: 100%; overflow-x: auto;">
                                        ...
                                        <table id="life" class="table table-bordered">
                                            <thead>
                                            <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @if($CheckLayoutPermission[0]->view==1)
                                                                <a class="btn btn-app view" title="View Enquiry"
                                                                   href="{{ route("life-insurance-enquiry.show",["id"=>$enquiry->id]) }}">
                                                            ...
                                                            @if($CheckLayoutPermission[0]->delete==1)
                                                                <a class="btn btn-app delete "
                                                                   ...
                                                                   href="{{ route("life-insurance-destroy",["id"=>$enquiry->id]) }}">

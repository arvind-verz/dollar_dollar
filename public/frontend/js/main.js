...
$(document).ready(function () {
    ...
    if (screen.width < 768) {
		...
		$(".ps-post--detail table,.ps-dashboard .ps-table,.ps-product .ps-table-wrap").wrap("<div class='table-responsive'></div>");
    ...
    $(".ps-criteria-detail>p").replace("This text only for test, Your text input here","");

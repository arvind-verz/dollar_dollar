                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-4">
                                    <div class="row-inner">
                                        <div class="image-gallery">
                                            <div id="about_big"><img src="{{ asset('images/office-2.jpg') }}" alt=""
                                                                     class="responsive bdr"></div>
                                            <ul class="pro-thumb">
                                                <li><a href="{{ asset('images/ISO-cert-2017-2018.jpg') }}"
                                                       rel="enlargeimage::mousedown" rev="about_big"><img
                                                                src="{{ asset('images/ISO-cert-2017-2018.jpg') }}"
                                                                alt="" class="responsive bdr"></a></li>
                                                <li><a href="{{ asset('images/BizSAFE-Level-4-2015-2018.jpg') }}"
                                                       rel="enlargeimage::mousedown" rev="about_big"><img
                                                                src="{{ asset('images/BizSAFE-Level-4-2015-2018.jpg') }}"
                                                                alt="" class="responsive bdr"></a></li>
                                                <li><a href="{{ asset('images/office-2.jpg') }}"
                                                       rel="enlargeimage::mousedown" rev="about_big"><img
                                                                src="{{ asset('images/office-2.jpg') }}" alt=""
                                                                class="responsive bdr"></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-12 col-md-8">
                                    <div class="row-inner">
                                        ...
                                        <p class="lead">Speedo Marine is a major supplier of an extensive range of
                                            ...
                                            best services and products in the field.</p>

                                        <p class="lead">Embracing our values of reliability, integrity, and efficiency,
                                            ...
                                            (Surabaya) and China (Shanghai, for insulation material).</p>
                                    </div>
                                </div>
                            </div>
                        </div>

    ...
    <div class="lg-left">
        ...
        <div class="grid-tb">
            ...
            <div class="grid-tc">
                ...
                <div class="title7 text-center"><strong>Forgot</strong> your Password?</div>
                <div class="login-form">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('password.email') }}">
                        {{ csrf_field() }}
                        <div class="form-group"><img src="{{asset('images/icon6.png')}}" alt="">
                            <input name="email" type="email" class="lg-input" placeholder="User ID / Email Address">
                            @if ($errors->has('email'))
                        ...
                        <div class="form-group mb0">
                            <button class="button btn-light-alt btn-block">Submit</button>
                        </div>
                    </form>
                </div>
            </div>
